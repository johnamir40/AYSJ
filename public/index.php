...
<body class="barber_version">
	...
	<header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
			<a  class="logo"><span>ASYJ </span>HOTEL</a>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="login.php?action=loginview">Login</a></li>
				...
				<div class="row align-items-center">
					<div class="col-md-6 text-left">
						<div class="message-box">
							...
							<h2>AYSJ?</h2>
							<p class="lead">
									ARQQA is a digital agency consists of strategists, creative minds, technologists, designers, marketers, storytellers, and inventors</p>
									...
									<a href="about.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Learn More</a>
						</div>
					</div>
					<div class="col-md-6 text-center">
						<div class="right-box">
							<img class="img-fluid" src="uploads/hr.png" alt="" />
						</div>
					</div>
				</div>
						...
						<div class="about-tab">
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="tab_a">
									<p>The most respected internet marketing agency. We want to change the way businesses speak, listen and share online.</p>
									<p>Our digital marketing work speaks for itself. We deliver an outstanding service custom-tailored to each and every one of our clients — big or small.</p>
								</div>
								<div class="tab-pane fade" id="tab_b">
									<p>We take our research and start to focus on structure and content and work through conceptual design ideas. We use working prototypes and visual design to bring ideas to life and ensure we design a great interface for your users. Our Digital Agency marries cutting edge expertise and a dynamic creative approach to evolve the online brand identity of our clients and to develop effective practices that maximize the impact of their presence on the Web. We bring your project to life with clean and standards-based code using the latest techniques and technologies.</p>

								</div>
								<div class="tab-pane fade" id="tab_c">
									<p>ARQQA is a digital agency consists of strategists, creative minds, technologists, designers, marketers, storytellers, and inventors</p>
		...
		<div class="copyrights">
			<div class="container">
              ...
              <a href="faq.php">Faq</a>
						...
						<p class="footer-company-name">All Rights Reserved. &copy; 2022 <a href="#">AYSJ</a> Design By : Sohaib Mohamed , Yossef Bassem , Ahmed Tareq , John Amir </p>
					</div>
				</div>
			</div>
		</div>
